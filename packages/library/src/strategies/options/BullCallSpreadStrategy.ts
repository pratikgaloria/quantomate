...
export class BullCallSpreadStrategy extends Strategy<any, any> {
  constructor(name: string, params: Partial<BullCallSpreadParams> = {}) {
    const { fastPeriod = 9, slowPeriod = 20, source = 'close', strikeOffset = 2 } = params;
