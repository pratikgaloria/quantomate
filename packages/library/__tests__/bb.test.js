...
describe('BB (Bollinger Bands)', () => {
    ...
    it('should calculate all bands correctly and maintain relationships', () => {
        ...
        const period = 20;
        const multiplier = 2;
        const upperBB = new src_1.BB('bb_upper', { period, multiplier, band: 'upper' });
        const middleBB = new src_1.BB('bb_middle', { period, multiplier, band: 'middle' });
        const lowerBB = new src_1.BB('bb_lower', { period, multiplier, band: 'lower' });
    ...
    it('should work with spread()', () => {
        const ds = new core_1.Dataset(data);
        const bb = new src_1.BB('bb_middle', { period: 20, multiplier: 2, band: 'middle' });
        bb.spread(ds);
